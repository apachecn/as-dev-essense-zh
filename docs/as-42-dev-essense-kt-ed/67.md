...
在“名称”字段中输入 LocalBound，并将 com . ebookwidge . local bound 指定为包名。在单击完成按钮之前，将最低API级别设置更改为API 26:安卓 8.0(奥利奥)，并将语言菜单更改为科特林。使用 [18.8 节【将项目迁移到视图绑定】中的步骤将项目迁移到视图绑定。](18.html#_idTextAnchor393)
