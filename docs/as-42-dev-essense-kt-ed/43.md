...
启动AndroidStudio，打开 ViewModelDemo 项目，编辑 MainFragment.kt 文件，修改代码如下:
...
使用数据绑定的第一步是在AndroidStudio项目中启用它。这包括向 Gradle Scripts-> build . Gradle(Module:viewmodeldemo . app)文件添加一个新属性。
