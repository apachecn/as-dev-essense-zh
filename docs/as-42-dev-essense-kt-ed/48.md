...
![](image/as_3.4_project_structure_suggestions.jpg)
...
![](image/as_3.2_navigation_new_resource_menu.jpg)

图 48-2

选择菜单项后，将出现“新建资源文件”对话框。在此对话框中，命名文件 navigation_graph，并将资源类型菜单更改为导航，如图 48-3 所示，然后单击确定按钮创建文件。

![](image/as_3.2_navigation_new_resource_file.jpg)
...
![](image/as_4.1_navigation_no_hosts.jpg)
...
![](image/as_3.6_add_navhostfragment.jpg)
...
![](image/as_4.1_navigation_host_added.jpg)
...
![](image/as_4.1_navigation_add_destination.jpg)

图 48-7

选择 main_fragment 作为目标，以便它出现在导航图中:

![](image/as_4.1_navigation_first_fragment_added.jpg)
...
![](image/as_3.2_navigation_second_destination.jpg)
...
![](image/as_4.1_navigation_demo_ui.jpg)
...
![](image/as_3.2_navigation_convert_framelayout.jpg)
...
![](image/as_4.1_navigation_connection_circle.jpg)

图 48-12

在圆圈内单击，并将结果行拖动到第二个片段目标:

![](image/as_4.1_navigation_connecting.jpg)

图 48-13

松开线，建立起点和终点之间的动作连接，此时线将变为箭头，如图[图 48-14](#_idTextAnchor960) :

![](image/as_4.1_navigation_connected.jpg)
...
对 SecondFragment.kt 文件重复上述步骤，这次引用 FragmentSecondBinding。
...
![](image/as_3.6_nav_graph_add_argument.jpg)

图 48-15

单击+按钮后，将出现一个对话框，需要在其中输入参数名称、类型和默认值。命名参数消息，将类型设置为字符串，并在默认值字段中输入无消息:

![](image/as_3.6_nav_graph_add_argument_dialog.jpg)
