...
在“名称”字段中输入 keycycledemo，并指定 com .ebook 狂潮. KeyCycleDemo 作为包名。在单击完成按钮之前，将最低 API 级别设置更改为 API 26:安卓 8.0(奥利奥)，并将语言菜单更改为 Kotlin。
...
请注意，在 AndroidStudio 运动布局编辑器中也可以查看关键周期波形，如下图[51-16](#_idTextAnchor1038)所示:
