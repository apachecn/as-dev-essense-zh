...
在“名称”字段中输入 DynamicFeature，并指定一个程序包名称，该名称将在 Google Play 生态系统中唯一标识您的应用。<your company="">。dynamicfeature)作为包名。在单击完成按钮之前，将最低API级别设置更改为API 26:安卓 8.0(奥利奥)，并将语言菜单更改为科特林。</your>
