...
![](image/as_4.1_direct_reply_ui.jpg)
...
![](image/as_4.1_direct_reply_notification.jpg)

图 63-2

轻按“回复”操作按钮，以使文本输入字段出现，显示创建远程输入对象时嵌入其中的回复标签。

![](image/as_4.1_direct_reply_enter_reply.jpg)
