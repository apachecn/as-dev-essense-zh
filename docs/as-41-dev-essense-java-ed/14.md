...
在“名称”字段中输入 StateChange，并将 com . ebookwidue . state change 指定为包名称。在单击完成按钮之前，将最低API级别设置更改为API 26:安卓 8.0(奥利奥)，并将语言菜单更改为 Java。项目创建过程完成后，状态更改项目应列在位于AndroidStudio主窗口左侧的项目工具窗口中。
