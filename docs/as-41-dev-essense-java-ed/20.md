...
![](image/as_4.1_layout_buttons_no_chain.jpg)
...
![](image/as_4.1_layout_horizontal_chain.jpg)
...
![](image/as_4.1_chain_style_attribute.jpg)
...
![](image/as_4.1_layout_horizontal_chain_spread_inside.jpg)
...
![](image/as_4.1_layout_horizontal_chain_packed.jpg)

图 20-5

20.5 带偏置的包装链样式

打包链的定位可能会受到施加偏置值的影响。偏差可以是 0.0 到 1.0 之间的任何值，0.5 代表父对象的中心。通过选择链头小部件并为属性面板中的布局 _ 约束水平 _ 偏置或布局 _ 约束垂直 _ 偏置属性赋值来控制偏置。[图 20-6](#_idTextAnchor503) 显示了水平偏差设置为 0 的包装链。2:

![](image/as_4.1_layout_horizontal_chain_packed_bias.jpg)
...
![](image/as_3.5_chain_match_constraints.jpg)

图 20-7

假设已选择展开链样式，并且所有三个按钮都已配置为宽度尺寸设置为与约束匹配，链中的小部件将相等地展开以填充可用空间:

![](image/as_4.1_layout_horizontal_chain_match_constraints.jpg)
...
![](image/as_4.1_layout_horizontal_chain_weight.jpg)
...
![](image/as_3.2_toggle_aspect_ratio_constraint.jpg)

图 20-10

默认情况下，比率大小控制处于关闭状态。单击控件启用比率约束，并显示一个可以更改比率的附加字段:

![](image/as_3.2_toggle_aspect_ratio_settings.jpg)
