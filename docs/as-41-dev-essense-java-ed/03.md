...
![](image/as_4.0_activity_template.jpg)
...
![](image/as_4.0_configure_project.jpg)
...
![](image/as_4.0_project_tool_window_menu.jpg)
...
![](image/as_4.1_layout_editor.jpg)

图 3-6

在布局编辑器窗口顶部的工具栏中有一个菜单(在上图中当前设置为像素)，它反映在布局编辑器面板中设备的视觉表示中。点击此菜单，可选择多种其他设备选项。

要在横向和纵向之间更改设备表示的方向，只需使用显示![](image/as_4.1_orientation.jpg)图标的设备选择菜单左侧的下拉菜单。
...
![](image/as_4.1_component_tree.jpg)
...
![](image/as_4.0_layout_autoconnect_off.jpg)
...
![](image/as_4.1_extract_resource.jpg)
...
![](image/as_4.1_gutter_color_chooser.jpg)
...
![](image/as_3.6_translations_editor.jpg)
